...
+ (void)animatedView:(UIView *)view inType:(MXAnimationInType)inAnimation inDuration:(CGFloat)inDuration inDelay:(CGFloat)inDelay completion:(void (^)())completion
{
...
+ (void)animatedView:(UIView *)view out:(MXAnimationOutType)inAnimation outDuration:(CGFloat)outDuration outDelay:(CGFloat)outDelay completion:(void (^)())completion
{
    UIView *superView = view.superview;
    CGRect superViewBounds = superView.bounds;
